...
public class EstadisticaJugador {
    ...
    public EstadisticaJugador(int id_estadistica, int minutos_jugados, int goles, int asistencias, int tarjetas_amarillas, int tarjetas_rojas, Jugador jugador, Partido partido) {
    ...
    public int getTarjetas_amarillas() { return tarjetas_amarillas; }
    public void setTarjetas_amarillas(int tarjetas_amarillas) { this.tarjetas_amarillas = tarjetas_amarillas; }
    public int getTarjetas_rojas() { return tarjetas_rojas; }
    public void setTarjetas_rojas(int tarjetas_rojas) { this.tarjetas_rojas = tarjetas_rojas; }
